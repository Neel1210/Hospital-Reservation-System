...
private HashMap<String,String> doctors;
    ...
    private void initComponents() {
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Doctor's Details", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Tahoma", 1, 18), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        jPanel3.add(jLabel26, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 40, -1, 243));
    ...
    private void btnRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegisterActionPerformed
       if(validateInput()==false){
        ...
        try{
            ...
            if(pw.getPassword().equals(repwd.getPassword()))
            {
                pwsd=PasswordEncryption.getEncryptedPassword(String.valueOf(pw.getPassword()));
            }
            else
            {
